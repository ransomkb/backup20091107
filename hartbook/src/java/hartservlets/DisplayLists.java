...
public final class DisplayLists extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
		...
		else if(req.getParameter("moverow") != null) // radiobutton input name in BookMethods
		{
			...
			//String set = moveList;
					...
					//ss.dbgApp("got here DispMove 0: typ = "+req.getParameter("wbType")); //debug
			...
			BookMethods.handleDispMove(req.getParameter("moverow"), ss);
