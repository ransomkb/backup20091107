...
public final class FirstHTTPHandler extends HttpServlet
{
		...
		throws ServletException, IOException
	{
		...
		{ 
            ...
            res.sendRedirect("/hartbook/front_page.jsp"); // redirects to first page of site
		...
		throws ServletException, IOException
	{
		...
		{
			ss.goBack = "/hartbook/register.jsp";
		...
		else if(req.getParameter("addwordsets") != null) 
		{
			...
			ss.goBack = "/hartbook/front_page.jsp";
