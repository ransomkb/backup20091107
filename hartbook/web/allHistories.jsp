...
%>
	...
	<%= ss.html.mainBodyRow() %>
        ...
        <form action='/<%= ss.exp.folder %>/oneHistory.jsp' method='post' name='oneStudent' id='oneStudent' accept-charset='UTF-8' >
	...
	<%= ss.html.begTable() %>
        <tr>
            ...
            <td width='150' valign='middle' align='right'>
                <table>
                    <tr>
                        <%= Buttons.roundButton(Buttons.getBut28(ss), ss) %>
                    </tr>
                </table>
            </td>
        </tr>
